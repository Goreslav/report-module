<template>
  <div class="container mx-auto p-8 max-w-4xl">
    <h1 class="text-3xl font-bold mb-6">Report Module Playground</h1>
    ...
    <div class="grid md:grid-cols-2 gap-8">
      ...
      <div class="space-y-6">
        ...
        <div class="bg-gray-50 p-6 rounded-lg">
          <h3 class="text-lg font-semibold mb-3">Test User Object</h3>
...
const testUser = ref({
  meno: 'John Doe',          // string - POVINNÉ
  ma: 12345,                 // number - POVINNÉ
  level: 'developer'         // string - POVINNÉ
})
